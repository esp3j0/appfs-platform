import { AgentNoActiveTurnError, SpawnConfigValidationError, } from '../process-manager.js';
export function registerProcessRoute(app, processManager) {
    ...
    app.post('/api/process/spawn', async (request, reply) => {
        try {
    ...
    app.post('/api/agents/:sessionId/prompt', async (request, reply) => {
        try {
    ...
    app.post('/api/agents/:sessionId/inputs/:requestId/guidance', async (request, reply) => {
        try {
    ...
    app.post('/api/agents/:sessionId/cancel-turn', async (request, reply) => {
        try {
            const { sessionId } = request.params;
    ...
    app.post('/api/agents/:sessionId/stop', async (request, reply) => {
        const { sessionId } = request.params;
    ...
    app.get('/api/agents/:sessionId/status', async (request, reply) => {
        const { sessionId } = request.params;
