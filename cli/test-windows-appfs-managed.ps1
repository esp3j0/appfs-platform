...
function Main {
    ...
    $registerToken = "reg-http-001" # @I-am-sure-its-safe
    ...
    $registerPayload = @{
        ...
        client_token = $registerToken # @I-am-sure-its-safe
    ...
    $enterScopePayload = @{
        ...
        client_token = "scope-http-001" # @I-am-sure-its-safe
    } | ConvertTo-Json -Compress
    ...
    $unregisterPayload = @{
        app_id = $AppId
        client_token = "unreg-http-001" # @I-am-sure-its-safe
    } | ConvertTo-Json -Compress
